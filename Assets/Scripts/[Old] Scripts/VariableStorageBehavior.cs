...
public class SQLVariableStorage : VariableStorageBehaviour {
    ...
    public override void SetAllVariables(Dictionary<string, float> strVar, Dictionary<string, string> floatVar, Dictionary<string, bool> boolVar, bool flip)
    {
        
    }

    public override void GetAllVariables(out Dictionary<string, float> strVar, out Dictionary<string, string> floatVar, out Dictionary<string, bool> boolVar)
    {
        strVar = YarnString.ToDictionary(db.Table<YarnString>());
        floatVar = YarnFloat.ToDictionary(db.Table<YarnFloat>());
        boolVar = YarnBool.ToDictionary(db.Table<YarnBool>());
    }
}
